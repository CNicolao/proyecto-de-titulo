...
class Ticket(models.Model):
    ...
    related_name='tickets_asignados_tecnico', 
    blank=True, 
    null=True
)
...
class Comentario(models.Model):
    ...
    def __str__(self):
        return f"Comentario por {self.usuario.username} en Ticket #{self.ticket.id}" # type: ignore
...
class Encuesta(models.Model):
    ...
    def __str__(self):
        return f"Encuesta para Ticket #{self.ticket.id} - Calificación: {self.calificacion}" # type: ignore
